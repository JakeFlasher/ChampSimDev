...
class RFMManager_PF : public IControllerPlugin, public Implementation {
    RAMULATOR_REGISTER_IMPLEMENTATION(IControllerPlugin, RFMManager_PF, "RFMManager_PF", "RFM Manager.")
