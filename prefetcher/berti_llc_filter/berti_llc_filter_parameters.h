# ifndef _berti_llc_filter_PARAMETERS_LLC_H_
# define _berti_llc_filter_PARAMETERS_LLC_H_

namespace berti_llc_filter_space
{
  /*
   ...
   *****************************************************************************/
  // berti_llc_filter
  # define berti_llc_filter_TABLE_SIZE             (64) // Big enough to fit all entries
  # define berti_llc_filter_TABLE_DELTA_SIZE       (16)
   ...
   *                              CONSTANT PARAMETERS                          *
   *****************************************************************************/
  # define berti_llc_filter_R                      (0x0)
  # define berti_llc_filter_L1                     (0x1)
  # define berti_llc_filter_L2                     (0x2)
  # define berti_llc_filter_L2R                    (0x3)


  # define berti_llc_filter_SETS (16)
  # define berti_llc_filter_WAYS (4)
  # define berti_llc_filter_TIMEOUT (150)
};
# endif